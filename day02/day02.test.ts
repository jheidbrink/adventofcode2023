...
describe("parse_draw", () => {
    it("should parse a draw", () => {
        expect(parse_draw("4 red, 2 green, 6 blue")).toEqual({red: 4, green: 2, blue: 6});
...
describe("parse_game", () => {
    it("should parse a line into a game object", () => {
        ...
        expect(parse_game(input)).toEqual({id: 31, draws: [{red: 4, green: 2, blue: 6}, {red: 1, green: 0, blue: 0}, {red: 2, green: 0, blue: 5}]});
    });
});
